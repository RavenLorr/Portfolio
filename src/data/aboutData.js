    ...
    en: {
        ...
        tabs: {
            basics: {
                icon: FaUser,
                title: "The Basics",
                content: "My name is Étienne, even thought I am commonly reffered to by my English name Ethan. I am a 21-year-old developer born in Québec, Canada. Currently, " +
                  "I am completing my studies in Application Development while also engaging in various contract and personal projects."
            },
            sport: {
                icon: FaRunning,
                title: "Sport",
                content: "I have a passion for sports, much like many others. During my childhood, I played soccer, and over the years, " +
            ...
            photography: {
                icon: FaCamera,
                title: "Photography",
                content: "One of my hobbies is photography. I take great pleasure in capturing moments, landscapes, and the beauty of people. " +
            ...
            drawing: {
                icon: FaPencilAlt,
                title: "Drawing",
                content: "I have always had a passion for drawing, a passion I kept since childhood. Although I wasn't particularly skilled at the time," +
            ...
            goals: {
                icon: FaFlag,
                title: "Goals",
                content: "I would love expand my knowledge in AI and machine learning, as well as improving my skills in web development. I am also interested in " +
    ...
    fr: {
        ...
        tabs: {
            basics: {
                icon: FaUser,
                title: "Les Bases",
                content: "Je m'appelle Étienne, bien que je sois normalement appelé par mon nom anglais Ethan. Je suis un développeur de 21 ans, né au Québec, Canada." +
            ...
            sport: {
                icon: FaRunning,
                title: "Sport",
                content: "J'ai une passion pour le sport, tout comme beaucoup d'autres. Durant mon enfance, j'ai joué au soccer, et au fil des ans, " +
            ...
            photography: {
                icon: FaCamera,
                title: "Photographie",
                content: "Un de mes passe-temps est la photographie. Je prends un grand plaisir à capturer des moments, des paysages, et la beauté des gens. " +
            ...
            drawing: {
                icon: FaPencilAlt,
                title: "Dessin",
                content: "J'ai toujours eu une passion pour le dessin, une passion que j'ai gardée depuis l'enfance. Bien que je n'étais pas particulièrement doué à l'époque," +
            ...
            goals: {
                icon: FaFlag,
                title: "Objectifs",
                content: "J'aimerais approfondir mes connaissances en IA et en apprentissage machine, ainsi qu'améliorer mes compétences en développement web. Je suis également intéressé à " +
