...
const Projects = () => {
    ...
    return (
        <div className="relative min-h-screen flex justify-center items-center p-20" style={{ fontSize: 'var(--root-font-size, 16px)' }}>
                            ...
                            <div className="p-4">
                                <ul className="flex flex-wrap">
                                    {project.tags.map(tag => (
                                        <li key={tag} className="bg-gray-700 text-white text-xs px-2 py-1 rounded mr-2 mb-2" style={{ fontSize: `${0.75 * scale}rem` }}>{tag}</li>
                                    ))}
                                </ul>
                            </div>
                        </motion.div>
